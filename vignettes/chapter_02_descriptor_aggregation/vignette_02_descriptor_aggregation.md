...
>
> An equivalent script using standard pandas groupby and lambda
> aggregation was generated by a large language model and refactored
> to use global constants — the fairest comparison. The script produces
> correct output.
> Script at
...
> |---|:---:|:---:|---|
> | Cleans the data | ✓ | ✓ | 99 lines vs 14 lines (7×) |
...
- **14 lines of analysis code vs 99 lines without eventus** (7×)
  — and the 99 lines produce correct output but cannot provide versioned
  aggregation rules, type-rule validation at construction, or the ability
  to change one rule without finding the right lambda. The gap is not
  correctness — it is transparency, auditability, and reproducibility
  as structural properties of the pipeline.

---

*The next chapter examines episode duration — how long were the
stays, and does duration differ across facilities?*
