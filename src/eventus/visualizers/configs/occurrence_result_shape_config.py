"""
occurrence_result_shape_config.py
...
def _default_density() -> HistogramPlotConfig:
    ...
    Density = n occurrences / observation duration in days.
    """
    return HistogramPlotConfig(
...
@dataclass
class OccurrenceResultShapeConfig(BasePlotConfig):
    """
    Full configuration for OccurrenceResultShapePlotter.
