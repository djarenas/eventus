"""
event_result_volume_config.py
Configuration for EventResultVolumePlotter.
...
@dataclass
class EventResultVolumeConfig(BasePlotConfig):
    """
    Full configuration for EventResultVolumePlotter.
    ...
    Example (from YAML):
        config = EventResultVolumeConfig.build_from_yaml("volume_config.yaml")

    Example (from dict):
        config = EventResultVolumeConfig.build_from_dict({
            "canvas":    {"figsize": [10, 5]},
