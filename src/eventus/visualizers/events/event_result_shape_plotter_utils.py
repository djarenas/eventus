"""
event_result_shape_plotter_utils.py
Drawing utilities for EventResultShapePlotter.
...
from eventus.visualizers.configs.event_result_shape_config import ShapeScatterConfig
...
def draw_fingerprint_scatter(
    ...
    if len(b) == 0:
        ax.text(
            0.5, 0.5,
            "Insufficient data\n(requires n ≥ 4 events per entity)",
...
def draw_distribution_histogram(
    ...
    defaults via the factory functions in event_result_shape_config.
