...
Drawing utilities specific to OccurrenceResultVolumePlotter.
...
def compute_prevalence(
    ...
    Parameters
    ----------
    n_col   : Per-entity occurrence count column.
...
def draw_discrete_percentile_lines(
    ...
    ----------
    ax      : Target Axes.
    n_col   : Raw per-entity occurrence count column (before bucketing).
...
def draw_count_distribution_bar(
    ...
    n_col     : Raw per-entity occurrence count column — used for percentile lines.
