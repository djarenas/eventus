"""
event_activity_over_time.py
EventActivityOverTime — validated result object from
...
_ERROR = "[EventActivityOverTime] Error"

_REQUIRED_COLS = {"day", "n_total", "n_active", "pct_active", "n_entered", "n_exited"}
_VALID_MODES   = {"normalized", "calendar"}


class EventActivityOverTime:
    """
    I am the result of CohortTimelineEventAnalyzer.compute_activity_over_time(), 
