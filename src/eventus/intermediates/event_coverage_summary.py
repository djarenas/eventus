"""
event_coverage_summary.py
EventCoverageSummary — structured summary of event coverage analysis
for one identity within a CohortTimeline.

Produced by
-----------
CohortTimelineEventAnalyzer.get_summary()
"""
from __future__ import annotations

_ERROR = "[EventCoverageSummary] Error"
...
class EventCoverageSummary:
    """
    I hold a structured summary of event coverage analysis for one identity.
    ...
    n_with_any_coverage: int   — entities with at least one event in obs period
    """
