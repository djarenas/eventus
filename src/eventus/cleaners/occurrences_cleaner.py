...
class OccurrencesCleaner:
    """
    I am a transparent, auditable pipeline that cleans raw occurrence
    ...
    def __init__(
        ...
        # Validate OccurrenceConsolidateConfig against semantics
    ...
    def _consolidate(self, df: pd.DataFrame) -> pd.DataFrame:
        """
        Consolidate same-date records into one occurrence per
